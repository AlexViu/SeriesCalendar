...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.RecyclerHolder> {

    SerieRepository seriesRepository = new SerieRepository();
    private List<SerieModel> listSeries;

    public FavoriteAdapter(List<SerieModel> items) {
    ...
    public RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavoriteAdapter.RecyclerHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerHolder holder, int position) {
        ...
        try {
            ...
            listSeries = seriesRepository.getFavorite("8");
